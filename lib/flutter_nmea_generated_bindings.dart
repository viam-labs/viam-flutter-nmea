...
/// Bindings to `src/flutter_nmea.h`.
class FlutterNmea {
  ...
  FlutterNmea(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  FlutterNmea.fromLookup(
  ...
  late final _parse_dataPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<ffi.Char> Function(
              ffi.Pointer<ffi.Char>, ffi.Int)>>('parse_data');
  late final _parse_data = _parse_dataPtr
